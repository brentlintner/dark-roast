...
(function() {
  var async, child_process, coffee, compile, compile_cs, copy_file, file_ext, fs, handle_err, log, logger, path, wrench, _,
    __slice = [].slice;
  ...
  compile_cs = function(cs_path, cs_opts, files) {
    ...
    return child_process.exec("coffee " + cs_opts + " " + cs_path, handle_err(function(stdout, stderr) {
